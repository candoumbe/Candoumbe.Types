...
#endif
{
...
#endif
    public static NonNegativeLong operator +(NonNegativeLong left,
                                             NonNegativeLong right)
    ...
    ///<inheritdoc/>
    public static bool operator <(NonNegativeLong left,
                                  NonNegativeLong right) => left.Value < right.Value;
...
#endif
    public static NonNegativeLong operator *(NonNegativeLong left,
                                             PositiveLong right) => From(left.Value * right.Value);
    ...
    /// <summary>
    /// Determines if <paramref name="value"/> is a <see langword="long"/>.
    /// </summary>
    /// <param name="value">the value to test</param>
    /// <returns><see langword="true"/></returns>
    ...
    /// <inheritdoc/>
    public static bool IsNegativeInfinity(NonNegativeLong value) => false;

    /// <inheritdoc/>
    public static bool IsNormal(NonNegativeLong value) => true;
...
#endif
    public static NonNegativeLong MaxMagnitude(NonNegativeLong x,
                                               NonNegativeLong y)
        => ( x > y ) switch
        {
            true => x,
    ...
    /// <inheritdoc/>
        ...
        /// <returns><paramref name="x"/> if <paramref name="x"/> is greater than <paramref name="y"/>; otherwise <paramref name="y"/>.</returns>
#endif
    public static NonNegativeLong MaxMagnitudeNumber(NonNegativeLong x,
                                                     NonNegativeLong y) => MaxMagnitude(x, y);

    /// <inheritdoc/>
    public static NonNegativeLong MinMagnitude(NonNegativeLong x,
                                               NonNegativeLong y) => MaxMagnitude(x, y) == x ? y : x;

    /// <inheritdoc/>
    public static NonNegativeLong MinMagnitudeNumber(NonNegativeLong x,
                                                     NonNegativeLong y) => MinMagnitude(x, y);

#if !NETSTANDARD2_0
    /// <inheritdoc/>
    public static NonNegativeLong Parse(ReadOnlySpan<char> s,
                                        NumberStyles style,
                                        IFormatProvider provider) => From(long.Parse(s, style, provider));
#endif

    /// <inheritdoc/>
    public static NonNegativeLong Parse(string s,
                                        NumberStyles style,
                                        IFormatProvider provider) => From(long.Parse(s, style, provider));
    ...
    public static bool TryParse(ReadOnlySpan<char> s,
                                ...
                                [MaybeNullWhen(false)] out NonNegativeLong result)
        => throw new NotImplementedException();
    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(false)] string s,
                                NumberStyles style,
                                IFormatProvider provider,
                                [MaybeNullWhen(false)] out NonNegativeLong result)
        => throw new NotImplementedException();
    ...
    /// <inheritdoc/>
    public static NonNegativeLong Parse(ReadOnlySpan<char> s,
                                        IFormatProvider provider) => From(long.Parse(s, provider));
